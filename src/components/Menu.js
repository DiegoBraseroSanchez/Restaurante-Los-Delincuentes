...
//pdf carta
import Documento from './Delincuentes.pdf'

const Menu = () => {
  //destructuracion menu data
     ...
     className='relative top-80 lg:top-96'>
      <div className='container mx-auto'>
            ...
            {menuItems.map((item, index)=>{
              ...
              <div key={index}>
                <div className='flex flex-row lg:flex-col h-full'>
                  ...
                  {/* text */}
                  <div className='bg-[#eed9be] flex-1 flex flex-col justify-center
        ...
        <button className='btn mx-auto capitalize'>
          <a href={Documento} download>{btnText}</a>
        </button>
      </div>
     </motion.div>
