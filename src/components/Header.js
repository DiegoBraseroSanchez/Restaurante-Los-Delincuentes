  ...
  >
    ...
    className='container mx-auto'>
      <div className='flex justify-between items-center px-4 lg:px-0 relative text-white'>
        ...
        flex flex-col items-center justify-center w-12 h-12 p-3 order-2 
        ...
        <motion.div variants={fadeIn('down', 'tween', 1.2, 1.4)}
          ...
          <a href='#'>
            <img 
            className= {`${isActive ? 'w-[100px] h-[100px]' : 'w-[200px] h-[200px]'}`} 
            src={LogoWhite}
            alt=''>          
            </img>
          </a>
